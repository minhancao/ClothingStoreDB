...
public class dataArrayLists {
    ...
    public static ArrayList<Double> shoeSize;
    ...
    public static ArrayList<Double> getShoeSize() {
        shoeSize = new ArrayList<>();
        for (int i = 6; i < 16; i++){
            shoeSize.add((double) i);
            shoeSize.add(i+0.5);
        }
        return shoeSize;
    }
    ...
    public static void main(String args[]){
        getWaistSizes().forEach(System.out::println);
        getLengthSizes().forEach(System.out::println);
    }
}
